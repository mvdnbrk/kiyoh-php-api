...
class BaseResourceTest extends TestCase
{
    ...
    public function encoding_malformed_json_throws_an_exception()
    {
        ...
        $this->expectExceptionMessage('Error encoding resource [Mvdnbrk\Kiyoh\Tests\Unit\Resources\ResourceStub] to JSON: Malformed UTF-8 characters, possibly incorrectly encoded.');
